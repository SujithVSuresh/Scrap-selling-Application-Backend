...
from .views import MyTokenObtainPairView, registerScraper, chartStatForAdmin, pickupAddressManagementForSeller, orderManagementForAdmin, statsForAdmin, sellRequestManagementForAdmin, scrapSellerManagementForAdmin, scrapBuyerAdminManagementForAdmin, scrapBuyerStaffManagementForAdmin, categoryManagementForAdmin, itemManagementForAdmin, cancelSellRequest, getAllSellRequestOrders, createSellRequest, scraperAdminProfileCreator, addStaffToBusiness, getAllStaffs, deactivateStaff, getAllSellRequests, getAllTodaysSellRequests, getAllPendingOrders, getAllCompletedOrders, completeOrder, cancelOrder, acceptSellRequest, getOrdersToCompleteTodayForScraperStaff, getAllCategoryAndItems, registerScrapSeller, getAllReviews, manageOrderReview
...
urlpatterns = [
    ...
    path('admin/chart-stat/', chartStatForAdmin, name='chartStatForAdmin'),
